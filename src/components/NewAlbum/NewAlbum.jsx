...
export default function NewAlbumF() {
    const heading = "New Albums";
    ...
    return (
        ...
        <div className={Styles.topAlbumContainer}>
            ...
            <div>
                ...
                </div>):(<div style={{display:"grid",gridTemplateColumns: "auto auto auto auto auto auto auto",gap:"3.15rem"}}>{newAlbum.map((ele) => (
                            <div key={ele.id}>
                                <CardComponent data={ele} />
                            </div>
                        ))}</div>)
